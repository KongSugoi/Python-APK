...
def extract_functions(file_path):
    ...
    with open(file_path, 'r') as f:
        ...
        for line in lines:
            if line.strip().startswith("void") or line.strip().startswith("public void") or line.strip().startswith("public static final") or line.strip().startswith("private void") or line.strip().startswith("public"):
...
folder_path = "D:\BTL_Python\File_out"
